...
/* LIGHT MODE — luxury marketplace ops (warm neutrals + champagne) */
:root {
  ...
  --card-border: 30 10% 90%;
  --sidebar: 30 10% 95%;
  --sidebar-foreground: 30 8% 12%;
  --sidebar-border: 30 10% 88%;
  --sidebar-primary: 37 38% 46%;
  --sidebar-primary-foreground: 36 30% 98%;
  --sidebar-accent: 30 12% 88%;
  --sidebar-accent-foreground: 30 8% 12%;
  --sidebar-ring: 37 38% 46%;
  --popover: 36 18% 98%;
  --popover-foreground: 30 8% 12%;
  --popover-border: 30 10% 88%;
  --primary: 37 38% 46%;
...
.dark {
  ...
  --border: 30 6% 16%;
  --card: 30 6% 10%;
  --card-foreground: 36 14% 94%;
  --card-border: 30 6% 14%;
  --sidebar: 30 6% 7%;
  --sidebar-foreground: 36 14% 90%;
  --sidebar-border: 30 6% 14%;
  --sidebar-primary: 37 42% 62%;
  --sidebar-primary-foreground: 30 12% 10%;
  --sidebar-accent: 30 6% 14%;
  --sidebar-accent-foreground: 36 14% 94%;
  --sidebar-ring: 37 42% 62%;
  --popover: 30 6% 11%;
  --popover-foreground: 36 14% 94%;
  --popover-border: 30 6% 16%;
  --primary: 37 42% 62%;
  --primary-foreground: 30 12% 10%;
  --secondary: 30 6% 16%;
  --secondary-foreground: 36 14% 94%;
  --muted: 30 6% 14%;
  --muted-foreground: 36 8% 64%;
  --accent: 30 6% 18%;
  --accent-foreground: 36 14% 94%;
  --destructive: 0 65% 48%;
  --destructive-foreground: 36 30% 98%;
  --input: 30 6% 22%;
  --ring: 37 42% 62%;
